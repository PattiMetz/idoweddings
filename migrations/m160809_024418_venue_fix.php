...
class m160809_024418_venue_fix extends Migration
{
    public function up()
    {
...
ALTER TABLE `venue_tax` ADD FOREIGN KEY (`organization_id`) REFERENCES `organization`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
