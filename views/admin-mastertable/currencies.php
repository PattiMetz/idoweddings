		...
		echo GridView::widget([
			...
			'columns' => [
		        ...
		        [
		            ...
		            'format' => 'raw',
		            'value' => function($data){
		                return Html::checkbox('is_main',
		                	($data->main==1)?true:false,['disabled'=>true]
		        ...
		        [
		            ...
		            'format' => 'raw',
		            'value' => function($data){
		                return ($data->rate*$data->control_amount);
		            },
		        ],
		        [
		            'label' => 'USD Amount with Buffer',
		            'format' => 'raw',
		            'value' => function($data){
		                return ($data->rate*$data->control_amount*$data->buffer);
		            },
		        ],
		        [
		            'label' => 'Last updated',
		            'format' => 'raw',
		            'value' => function($data){
		                return ($data->updated_at.'<br/>By Patti');
		            },
		        ],
		        [
